...
module.exports = async (req,res) =>{
    ...
    if(same){
        return res.render('g2',{ userData:false, appointmentData: null,user: null, message:null });
    }else{
        ...
        return res.render('g2',{ userData:user, appointmentData: { date: formattedDate, time}, user: null, message:null });
    }
}